...
<body class="bg-gray-100 w-full">
    <div class="h-screen relative w-full">
        ...
        <div class="flex basis-full min-h-screen relative">
            <div class="w-1/2 bg-[url(https://www.virajtechnologies.com/assets/img/ecomm.jpg)] bg-cover bg-no-repeat min-h-full xs:hidden tablet:hidden md:hidden  lg:block laptop:block desktop:block 2xl:block 3xl:block 4xl:block"></div>
                        ...
                        <div class="flex flex-col space-y-7 w-[400px] laptop:px-0 px-8 ">
                            ...
                            <div class="input-field relative">
                                ...
                                <div class="flex justify-center items-center text-center m-auto">
                                    ...
                                    />
                                    <div
                                        class="eye-icon absolute right-0 flex items-center pr-3 cursor-pointer"
                            ...
                            <div class="input-field">
                                <button
                                    ...
                                    class="bg-blue-700 text-white rounded-md p-2 h-[54px] w-full"
                                    type="submit"
                                >
                                    Login
                                </button>
